...
export const translations: Translations = {
  ca: {
    ...
    csvFormatInfo: 'Format del Fitxer CSV (valors separats per comes): Hi ha dues columnes obligatòries, una amb el País i una columna amb la Ciutat. Altres columnes seran ignorades',
  ...
  es: {
    ...
    csvFormatInfo: 'Formato del Archivo CSV (valores separados por comas): Hay dos columnas obligatorias, una con el País y una columna con la Ciudad. Otras columnas serán ignoradas',
  ...
  en: {
    ...
    csvFormatInfo: 'Format of the CSV File (comma separated value): There are two mandatory columns, one with the Country and a column with the City. Other columns will be ignored',
